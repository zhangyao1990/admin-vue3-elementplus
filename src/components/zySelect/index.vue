...
<template>
	<div class="zy-select">
		<div v-if="initloading" class="zy-select-loading">
...
<style scoped>
	.zy-select {display: inline-block;position: relative;}
	.zy-select-loading {position: absolute;top:0;left:0;right:0;bottom:0;background: #fff;z-index: 100;border-radius: 5px;border: 1px solid #EBEEF5;display: flex;align-items: center;padding-left:10px;}
	.zy-select-loading i {font-size: 14px;}

	[data-theme='dark'] .zy-select-loading {background: var(--el-color-white);border-color: var(--el-border-color-base) ;}
</style>
