		...
		<el-table :data="data" ref="table" :key="toggleIndex" border stripe>
			<el-table-column type="index" width="50" fixed="left">
				...
				<template #default="scope">
					<div class="zy-form-table-handle">
...
<style scoped>
	.zy-form-table .zy-form-table-handle {text-align: center;}
	.zy-form-table .zy-form-table-handle span {display: inline-block;}
	.zy-form-table .zy-form-table-handle button {display: none;}
	.zy-form-table .hover-row .zy-form-table-handle span {display: none;}
	.zy-form-table .hover-row .zy-form-table-handle button {display: inline-block;}
</style>
