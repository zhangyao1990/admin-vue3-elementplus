			...
			<el-col>
				...
				<el-form :model="form" :rules="rules" ref="dialogForm" label-width="80px" label-position="left">
					...
					<el-form-item label="菜单图标" prop="meta.icon">
						<zy-icon-select v-model="form.meta.icon" clearable></zy-icon-select>
					</el-form-item>
					...
					<el-form-item label="接口权限" prop="apiList">
						<zy-form-table v-model="form.apiList" :addTemplate="apiListAddTemplate" placeholder="暂无匹配接口权限">
...
<script>
	import zyIconSelect from '@/components/zyIconSelect'
	...
	export default {
		...
		methods: {
			...
			async save(){
				this.loading = true
				var res = await this.$API.system.post.post(this.form)
				this.loading = false
				if(res.code == 200){
