<template>
	<el-container>
		...
		<el-container class="is-vertical">
			...
			<el-main class="nopadding">
				<zyTable ref="table" :apiObj="listApi" row-key="id" :params="listApiParams" @selection-change="selectionChange" stripe :paginationLayout="'prev, pager, next'">
		...
		methods: {
			...
			saveList(){
				this.$refs.listDialog.submit(async (formData) => {
					...
					var res = await this.$API.system.post.post(formData);
