<template>
	<div class="login_bg">
		<div class="login_adv" style="background-image: url(img/auth_login_bj.png);">
			<div class="login_adv__title">
				<h4>高性能 / 精致 / 优雅</h4>
				<p>基于Vue3 + Element-Plus 的中后台前端解决方案。</p>
				<div>
					<span><i class="zy-icon-vuejs-fill"></i></span>
		...
		<div class="login_main">
			<div class="login_config">
				<el-button :icon="config.theme=='dark'?'el-icon-sunny':'el-icon-moon'" circle type="info"
						   @click="configTheme"></el-button>
			...
			<div class="login-form">
				<div class="login-header">
					<div class="logo">
						...
						<label><span class="left-name">欢迎来到 </span>{{$CONFIG.APP_NAME}}</label>
					</div>
					<h2>用户登录</h2>
				</div>
				<el-form ref="loginForm" :model="ruleForm" :rules="rules" label-width="0"
						 size="large">
					<el-form-item prop="user">
						<el-input v-model="ruleForm.user" prefix-icon="el-icon-user" clearable placeholder="请输入用户名">
<!--							<template #append>-->
	...
	export default {
		...
		methods: {
			async login() {
				...
				this.$message.success("欢迎登录 vue admin plus")
				this.islogin = false
			},
			configTheme() {
...
<style scoped>
	...
	.login-header .logo label .left-name {
		font-size: 26px;
	}
